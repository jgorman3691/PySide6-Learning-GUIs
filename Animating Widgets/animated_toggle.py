...
from PySide6.QtWidgets import QWidget, QMainWindow, QApplication, QCheckBox
...
class AnimatedToggle(QCheckBox):
   ...
   def paintEvent(self, e: QPaintEvent):
      ...
      # The handle will move alone this line:
      ...
      def handle_position(self, pos):
         """
         Change the Property
         We need to trigger the QWidget.update() method, either by
         1.) Call it here (which is what we're doing)
         2.) Connect the QPropertyAnimation.valueChanged() signal to it
         :param self:
         :param pos:
         :return:
         """
